...
import com.liferay.kris.form.user.listener.FormUserAccountListenerConfiguration;
  ...
  private void addInactiveUser(DDMFormInstanceRecordVersion formRecord) {
    ...
    try {
      ...
      User newUser = _userLocalService.addUser(
          ...
          true, null, fields.getOrDefault("field09742064", ""),
          -1L, null, formRecord.getDDMForm().getDefaultLocale(),
          fields.getOrDefault("field34296186", ""), fields.getOrDefault("field98796378", ""),
          fields.getOrDefault("field99733565", ""), -1L, -1L, false,
          1, 1, 1970, null, null,
  ...
  private void activateUser(DDMFormInstanceRecordVersion formRecord) {
    ...
    try {
      ...
      User user = _userLocalService
          .getUserByEmailAddress(formRecord.getCompanyId(), fields.get("field09742064"));
